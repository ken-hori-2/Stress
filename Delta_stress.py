...
class IdealCamera:
    def __init__(self, env_map,                  distance_range=(0.5, 1.0),
...
if __name__ == '__main__':   ###name_indent
    ...
    m.append_landmark(Landmark(0,-1))
    m.append_landmark(Landmark(0,1))
    m.append_landmark(Landmark(0,3))
    world.append(m)          
    ...
    robot1 = IdealRobot( np.array([ 0, -3, math.pi/2]).T,    sensor=IdealCamera(m), agent=straight )
